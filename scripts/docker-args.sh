...
get-prod-args() {
    declare -a PROD_ARGS_LIST=(
        "YABONZA_ENV=PROD" "AUTH0_CLIENT_SECRET=$AUTH0_PROD_CLIENT_SECRET" "AWS_ACCESS_KEY_ID=$AWS_PROD_ACCESS_KEY_ID" "AWS_SECRET_ACCESS_KEY=$AWS_PROD_SECRET_ACCESS_KEY" "AWS_DEFAULT_REGION=$AWS_PROD_DEFAULT_REGION"
    )
    PROD_ARGS=""
...
get-dev-args() {
    declare -a DEV_ARGS_LIST=(
        "YABONZA_ENV=DEV" "AUTH0_CLIENT_SECRET=$AUTH0_DEV_CLIENT_SECRET" "AWS_ACCESS_KEY_ID=$AWS_DEV_ACCESS_KEY_ID" "AWS_SECRET_ACCESS_KEY=$AWS_DEV_SECRET_ACCESS_KEY" "AWS_DEFAULT_REGION=$AWS_DEV_DEFAULT_REGION"
    )
    DEV_ARGS=""
...
get-sandbox-args() {
    declare -a SANDBOX_ARGS_LIST=(
        "YABONZA_ENV=SANDBOX" "AUTH0_CLIENT_SECRET=$AUTH0_SANDBOX_CLIENT_SECRET" "AWS_ACCESS_KEY_ID=$AWS_SANDBOX_ACCESS_KEY_ID" "AWS_SECRET_ACCESS_KEY=$AWS_SANDBOX_SECRET_ACCESS_KEY" "AWS_DEFAULT_REGION=$AWS_SANDBOX_DEFAULT_REGION"
    )
    SANDBOX_ARGS=""
